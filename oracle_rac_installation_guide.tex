...
\usepackage{csquotes}
\usepackage{datetime}
\newdate{date}{11}{12}{2021}
\bibliography{rac_bib.bib}
...
\title{Oracle RAC: Una Guía de Instalación para el Humano}
...
Con estos pasos básicos es posible continuar desarrollando el aplicativo con Nest.js, aun así se estará proporcionando un \href{https://github.com/Je12emy/oracle_cluster}{repositorio con un aplicativo básico} para poder interactuar con la base de datos.
